...
var searchbar_component_SearchBar = function (_React$PureComponent) {
  ...
  _createClass(SearchBar, [{
    ...
    key: '__renderContent__REACT_HOT_LOADER__',
    value: function __renderContent__REACT_HOT_LOADER__() {
      return this.props.tooltip ? external___root___React___commonjs2___react___commonjs___react___amd___react___umd___react___default.a.createElement(
        OverlayTrigger["a" /* default */],
        { placement: 'bottom', overlay: this.getTooltip(), delay: this.props.tooltipDelay },
